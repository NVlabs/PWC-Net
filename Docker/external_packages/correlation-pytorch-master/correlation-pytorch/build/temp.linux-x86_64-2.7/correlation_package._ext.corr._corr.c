...
_cffi_f_corr1d_cpu_backward(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    x0 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x1 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x2 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x3 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x4 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(29), arg4, (char **)&x4,
            datasize, &large_args_free) < 0)
      return NULL;
  }
  ...
  if (datasize != 0) {
    x5 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x6 = ((size_t)datasize) <= 640 ? (THFloatTensor *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(29), arg6, (char **)&x6,
            datasize, &large_args_free) < 0)
      return NULL;
  }
...
_cffi_f_corr1d_cuda_backward(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    x3 = ((size_t)datasize) <= 640 ? (THCudaTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x4 = ((size_t)datasize) <= 640 ? (THCudaTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x5 = ((size_t)datasize) <= 640 ? (THCudaTensor *)alloca((size_t)datasize) : NULL;
  ...
  if (datasize != 0) {
    x6 = ((size_t)datasize) <= 640 ? (THCudaTensor *)alloca((size_t)datasize) : NULL;
